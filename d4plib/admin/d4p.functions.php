...
if ( ! function_exists( 'd4p_render_select' ) ) {
	function d4p_render_select( $values, $args = [], $attr = [] ) {
		$defaults = [
			'selected' => '',
			'name'     => '',
			'id'       => '',
...
if ( ! function_exists( 'd4p_render_grouped_select' ) ) {
	function d4p_render_grouped_select( $values, $args = [], $attr = [] ) {
		$defaults = [
			'selected' => '',
			'name'     => '',
			'id'       => '',
...
if ( ! function_exists( 'd4p_render_checkradios' ) ) {
	function d4p_render_checkradios( $values, $args = [], $attr = [] ) {
		$defaults = [
			'selected' => '',
			'name'     => '',
			'id'       => '',
...
if ( ! function_exists( 'd4p_render_checkradios_with_hierarchy' ) ) {
	function d4p_render_checkradios_with_hierarchy( $values, $args = [], $attr = [] ) {
		$defaults = [
			'selected' => '',
			'name'     => '',
			'id'       => '',
...
if ( ! function_exists( 'd4p_render_toggle_block' ) ) {
	function d4p_render_toggle_block( $title, $content, $classes = [] ) {
