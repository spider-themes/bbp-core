...
;(function($, window, document, undefined) {
	d4plib_admin = {
		...
		settings: function() {
			...
			$( document ).on(
				"click",
				".d4p-group h3 i.fa.fa-caret-down, .d4p-group h3 i.fa.fa-caret-up",
				function() {
			...
			$( ".d4p-setting-expandable_pairs a.button-primary" ).click(
				function(e) {
					e.preventDefault();
			...
			$( document ).on(
				"click",
				".d4p-setting-expandable_regex .button-secondary",
				function(e){
					d4plib_admin.handlers.expendable_text_remove( this, e );
				}
			);

			$( ".d4p-setting-expandable_text a.button-primary" ).click(
				function(e) {
					d4plib_admin.handlers.expendable_text_add( this, e, ".d4p-setting-expandable_text" );
				}
			);

			$( ".d4p-setting-expandable_raw a.button-primary" ).click(
				function(e) {
					d4plib_admin.handlers.expendable_text_add( this, e, ".d4p-setting-expandable_raw" );
				}
			);

			$( ".d4p-setting-expandable_regex a.button-primary" ).click(
				function(e) {
