...
if (!class_exists('d4p_object_fontawesome')) {
    class d4p_object_fontawesome {
        ...
        public function render_selector($args = array()) {
            $defaults = array(
                'icon_class' => 'd4p-fa-icon', 
                'selected_class' => 'd4p-fa-selected',
                'fixed_width' => true, 
                'tag' => 'span',
                'selected' => ''
            );
            ...
            foreach ($this->icons as $icon) {
                ...
                if ($selected == $icon) {
                    $class_wrapper.= ' '.$selected_class;
                }

                echo '<'.$tag.' class="'.$class_wrapper.'" title="'.$title.'"><i data-icon="'.$icon.'" class="'.$class.'"></i></'.$tag.'>';
            }
        }
    }
}
