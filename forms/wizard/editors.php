<div>
    <p>
        <?php _e("You can easily replace default, basic editor used for topics and replies with one of the additional editors supported by bbPress and GD bbPress Toolbox Pro.", "bbp-core"); ?>
    </p>
</div>
...
<div class="d4p-wizard-option-block d4p-wizard-block-yesno">
    ...
    <div>
        ...
        <span>
            ...
            <label for="gdbbx-wizard-editors-replace-yes"><?php _e("Yes", "bbp-core"); ?></label>
        </span>
        <span>
            ...
            <label for="gdbbx-wizard-editors-replace-no"><?php _e("No", "bbp-core"); ?></label>
        </span>
    </div>
</div>
...
<div class="d4p-wizard-connect-wrapper" id="gdbbx-wizard-connect-editor-replace" style="display: none;">
    <div class="d4p-wizard-option-block d4p-wizard-block-select">
        ...
        <div>
            ...
            <span>
                <label for="gdbbx-wizard-editors-mime"><?php _e("Topic Content Editor", "bbp-core"); ?></label>
...
<div class="d4p-wizard-option-block d4p-wizard-block-yesno">
    ...
    <div>
        ...
        <span>
            ...
            <label for="gdbbx-wizard-editors-library-yes"><?php _e("Yes", "bbp-core"); ?></label>
        </span>
        <span>
            <input type="radio" name="gdbbx[wizard][editors][library]" value="no" id="gdbbx-wizard-editors-library-no" checked />
            <label for="gdbbx-wizard-editors-library-no"><?php _e("No", "bbp-core"); ?></label>
        </span>
    </div>
</div>
