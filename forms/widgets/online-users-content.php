...
$_templates = apply_filters( 'gdbbx-widget-onlineusers-templates', array(
	'gdbbx-widget-onlineusers.php' => __( "Default layout", "bbp-core" ) . ' [' . 'gdbbx-widget-onlineusers.php' . ']'
) );
...
<table>
    ...
    <tr>
        <td class="cell-left">
			...
			<?php d4p_render_select( $_sel_userinfo, array( 'id'       => $this->get_field_id( 'show_users' ),
			                                                'class'    => 'widefat',
