...
$_templates = apply_filters( 'gdbbx-widget-userprofile-templates', array(
	'gdbbx-widget-userprofile.php'          => __( "Default two columns layout", "bbp-core" ) . ' [' . 'gdbbx-widget-userprofile.php' . ']',
	'gdbbx-widget-userprofile-enhanced.php' => __( "Enhanced single column layout", "bbp-core" ) . ' [' . 'gdbbx-widget-topicinfo-enhanced.php' . ']'
) );
