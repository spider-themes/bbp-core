...
$_templates = apply_filters( 'gdbbx-widget-topicinfo-templates', array(
	'gdbbx-widget-topicinfo.php'            => __( "Default table layout", "bbp-core" ) . ' [' . 'gdbbx-widget-topicinfo.php' . ']',
	'gdbbx-widget-topicinfo-icons.php'      => __( "Default table layout", "bbp-core" ) . ', ' . __( "with icons", "bbp-core" ) . ' [' . 'gdbbx-widget-topicinfo-icons.php' . ']',
	'gdbbx-widget-topicinfo-list.php'       => __( "Enhanced list layout", "bbp-core" ) . ' [' . 'gdbbx-widget-topicinfo-list.php' . ']',
	'gdbbx-widget-topicinfo-list-icons.php' => __( "Enhanced list layout", "bbp-core" ) . ', ' . __( "with icons", "bbp-core" ) . ' [' . 'gdbbx-widget-topicinfo-list-icons.php' . ']'
) );
