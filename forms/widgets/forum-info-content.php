...
$_templates = apply_filters(
	'bbpc-widget-foruminfo-templates',
	[
		'bbpc-widget-foruminfo.php'            => __( 'Default table layout', 'bbp-core' ) . ' [' . 'bbpc-widget-foruminfo.php' . ']',
		'bbpc-widget-foruminfo-icons.php'      => __( 'Default table layout, with icons', 'bbp-core' ) . ' [' . 'bbpc-widget-foruminfo-icons.php' . ']',
		'bbpc-widget-foruminfo-list.php'       => __( 'Enhanced list layout', 'bbp-core' ) . ' [' . 'bbpc-widget-foruminfo-list.php' . ']',
		'bbpc-widget-foruminfo-list-icons.php' => __( 'Enhanced list layout, with icons', 'bbp-core' ) . ' [' . 'bbpc-widget-foruminfo-list-icons.php' . ']',
	]
);
