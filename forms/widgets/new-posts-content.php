...
$_templates = apply_filters(
	'bbpc-widget-newposts-templates',
	[
		'bbpc-widget-newposts.php' => __( 'Default post layout', 'bbp-core' ) . ' [' . 'bbpc-widget-newposts.php' . ']',
	]
);
	...
	<tr>
		<td class="cell-left">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_thumbnail' ),
					'class'    => 'widefat',
		...
		<td class="cell-right">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_forum' ),
					'class'    => 'widefat',
	...
	<tr>
		<td class="cell-left">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_date' ),
					'class'    => 'widefat',
		...
		<td class="cell-right">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_tags' ),
					'class'    => 'widefat',
	...
	<tr>
		...
		<td class="cell-right">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_author_avatar' ),
					'class'    => 'widefat',
	...
	<tr>
		<td class="cell-left">
			...
			d4p_render_select(
				$_sel_date,
				[
					'id'       => $this->get_field_id( 'display_prefixes' ),
					'class'    => 'widefat',
