...
<table>
	...
	<tr>
		<td class="cell-left">
			<div class="d4plib-checkbox-list bbpc-views-list">
				<ul class="bbpc-views-ul">
					<?php
					...
					foreach ( $_act as $view ) {
						echo sprintf(
							'<li class="bbx-view-item-%s" data-view="%s"><label><input type="checkbox" name="%s[]" value="%s"%s />%s</label></li>',
							$view,
							$view,
							$this->get_field_name( 'views' ),
							$view,
							'checked="checked"',
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery("a.bbpc-tab-topics-views.d4plib-tab-active").click();
	});
</script>
