...
<h4><?php _e( "For Developers", "d4plib" ); ?></h4>
<table>
    <tbody>
    <tr>
        <td class="cell-singular">
            <label for="<?php echo $this->get_field_id( '_devid' ); ?>"><?php _e( "Developer ID", "d4plib" ); ?>:</label>
            ...
            <em>
				<?php _e( "This is custom string (alphanumeric, underscore and minus signs allowed) that can be used to identify the widget in code, and it can be useful for developers customizing the website.", "d4plib" ); ?>
            </em>
        </td>
    </tr>
    </tbody>
