...
echo '<a class="button-primary gdbbx-edit-attachment-attach" data-nonce="'.wp_create_nonce('gdbbx-att-'.$post_id).'" data-post="'.$post_id.'" href="#">'.__("Add attachment", "bbp-core").'</a><br/><br/>';
