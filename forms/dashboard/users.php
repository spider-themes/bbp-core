...
<div class="d4p-group d4p-group-dashboard-card d4p-group-dashboard-users">
	...
	<div class="d4p-group-stats">
		<ul>
			<li><a href="admin.php?page=bbp-core-users">
		...
		<ul>
			<?php foreach ( $statistics['user_roles_count'] as $role => $count ) { ?>
				<li><a href="admin.php?page=bbp-core-users&filter-role=<?php echo $role; ?>">
	...
	<div class="d4p-group-inner">
		<?php if ( bbpc()->get( 'track_last_activity_active', 'tools' ) ) { ?>
	...
	<div class="d4p-group-footer">
		<a href="admin.php?page=bbp-core-users" class="button-primary"><?php _e( 'All Users', 'bbp-core' ); ?></a>
	</div>
</div>
