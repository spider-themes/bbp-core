...
<div class="d4p-group d4p-group-dashboard-card d4p-group-dashboard-basic">
	...
	<div class="d4p-group-stats">
		...
		<hr/>
		<ul>
			<li><a href="admin.php?page=bbp-core-attachments">
			...
			<li><a href="admin.php?page=bbp-core-attachments&filter-attached=<?php echo bbp_get_topic_post_type(); ?>">
					<i aria-hidden="true" class="d4p-icon d4p-icon-bbpress-topic d4p-icon-fw"></i>
					<strong><?php echo $statistics['attachments_topic_count']; ?></strong>
					<?php _e( 'Attachments in Topics', 'bbp-core' ); ?></a>
			</li>
			<li><a href="admin.php?page=bbp-core-attachments&filter-attached=<?php echo bbp_get_reply_post_type(); ?>">
					<i aria-hidden="true" class="d4p-icon d4p-icon-bbpress-reply d4p-icon-fw"></i>
	...
	<div class="d4p-group-inner">
		...
		<p>
			...
			$day = bbpc_db()->count_recent_posts( DAY_IN_SECONDS, null, true );
			...
			echo sprintf( __( 'Published <strong>%1$s</strong> and <strong>%2$s</strong>.', 'bbp-core' ), $_topics, $_replies );
		...
		<p>
			...
			$week = bbpc_db()->count_recent_posts( WEEK_IN_SECONDS, null, true );
