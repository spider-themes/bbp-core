...
$thanks = bbpc_db()->thanks_statistics();
$latest = bbpc_db()->thanks_list_recent( 5 );
...
<div class="d4p-group d4p-group-dashboard-card d4p-group-dashboard-thanks">
	...
	<div class="d4p-group-stats">
		<ul>
			<li><a href="admin.php?page=bbp-core-thanks-list&filter-type=<?php echo bbp_get_topic_post_type(); ?>">
			...
			<li><a href="admin.php?page=bbp-core-thanks-list&filter-type=<?php echo bbp_get_reply_post_type(); ?>">
		...
		<hr/>
		<ul>
			<li><a href="admin.php?page=bbp-core-thanks-list">
	...
	<div class="d4p-group-inner">
		...
		<ul>
			...
			<li>
				...
				$_template = $report->post_type == bbp_get_topic_post_type() ? _x( '%1$s thanked %2$s for topic %3$s.', 'Dashboard thanks widget list items', 'bbp-core' ) : _x( '%1$s thanked %2$s for reply %3$s.', 'Dashboard thanks widget list items', 'bbp-core' );
	...
	<div class="d4p-group-footer">
		<a href="admin.php?page=bbp-core-thanks-list" class="button-primary"><?php _e( 'All Thanks List', 'bbp-core' ); ?></a>
	</div>
</div>
