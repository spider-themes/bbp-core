...
$reports = bbpc_db()->report_statistics();
$latest  = bbpc_db()->report_list_recent( 5 );
...
<div class="d4p-group d4p-group-dashboard-card d4p-group-dashboard-report">
	...
	<div class="d4p-group-stats">
		<ul>
			<li><a href="admin.php?page=bbp-core-reported-posts&filter-type=<?php echo bbp_get_topic_post_type(); ?>">
			...
			<li><a href="admin.php?page=bbp-core-reported-posts&filter-type=<?php echo bbp_get_topic_post_type(); ?>&filter-status=waiting">
					<i aria-hidden="true" class="d4p-icon d4p-icon-bbpress-topic d4p-icon-fw"></i> 
		...
		<hr/>
		<ul>
			<li><a href="admin.php?page=bbp-core-reported-posts&filter-type=<?php echo bbp_get_reply_post_type(); ?>">
			...
			<li><a href="admin.php?page=bbp-core-reported-posts&filter-type=<?php echo bbp_get_reply_post_type(); ?>&filter-status=waiting">
					<i aria-hidden="true" class="d4p-icon d4p-icon-bbpress-reply d4p-icon-fw"></i> 
	...
	<div class="d4p-group-inner">
		...
		if ( empty( $latest ) ) {
			...
			?>
		<p><?php _e( 'Nothing to report.', 'bbp-core' ); ?></p>
			<?php
		...
		<ul>
			...
			<li>
				...
				$_template = $report->post_type == bbp_get_topic_post_type() ? _x( "%1\$s reported topic %2\$s: '%3\$s'.", 'Dashboard reports widget list items', 'bbp-core' ) : _x( "%1\$s reported reply %2\$s: '%3\$s'.", 'Dashboard reports widget list items', 'bbp-core' );
	...
	<div class="d4p-group-footer">
		<a href="admin.php?page=bbp-core-reported-posts" class="button-primary"><?php _e( 'All Reported Posts', 'bbp-core' ); ?></a>
	</div>
</div>
