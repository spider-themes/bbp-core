...
$_classes = [ 'd4p-wrap', 'wpv-' . BBPC_WPV, 'd4p-page-install' ];
	...
	<div class="d4p-content">
		...
		<div class="d4p-content-right">
			<div class="d4p-update-info">
				...
				require BBPC_PATH . 'forms/setup/transfer.php';
				...
				?>
				<br/><br/><a class="button-primary" href="admin.php?page=bbp-core-about&install=on"><?php _e( 'Click here to continue.', 'bbp-core' ); ?></a>
			</div>
			<?php echo bbpc_plugin()->recommend( 'install' ); ?>
		</div>
	</div>
</div>
