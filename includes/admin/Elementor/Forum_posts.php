...
class Forum_posts extends Widget_Base {
	...
	public function get_title() {
		return __( 'Forum Posts', 'ama-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'ppp', [
				'label' => esc_html__( 'Show Forum Topics', 'ama-core' ),
                ...
                <div class="community-post wow fadeInUp" data-wow-delay="0.5s">
                    <div class="post-content">
                        ...
                        <div class="entry-content">
	                        ...
	                        <?php esc_html_e('Last active: ', 'ama-core'); echo bbp_get_forum_last_active_time(get_the_ID()) ?>
