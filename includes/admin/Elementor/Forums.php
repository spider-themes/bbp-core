	...
	protected function register_controls() {
		...
		$this->add_control(
			'ppp', [
				...
				'description' => esc_html__( 'Show the forums count at the initial view. Default is 5 forums in a row.', 'ama-core' ),
		...
		$this->add_control(
			'ppp2', [
				'label' => esc_html__( 'Hidden Forums', 'ama-core' ),
				'description' => esc_html__( 'Hidden forums will show on clicking on the More button.', 'ama-core' ),
				'type' => Controls_Manager::NUMBER,
				'label_block' => true,
				'default' => 10
			]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Forum Title Typography', 'ama-core' ),
         ...
         $this->add_group_control(
             ...
             [
                 ...
                 'label' => esc_html__( 'More text typography', 'ama-core' ),
                 'scheme' => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
         ...
         $this->add_control(
             'more_text_color',
             [
                 'label' => esc_html__( 'More text color', 'ama-core' ),
