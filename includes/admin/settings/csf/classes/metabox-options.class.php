          ...
          echo '<div class="csf-content">';
            ...
            foreach ( $this->sections as $section ) {
              ...
              if ( ! empty( $section['fields'] ) ) {
                ...
                echo '<div class="csf-no-option">'. esc_html__( 'No data available.', 'bbp-core' ) .'</div>';
            ...
            if ( ! empty( $this->args['show_restore'] ) || ! empty( $this->args['show_reset'] ) ) {
              ...
              echo '<span class="button csf-button-reset">'. esc_html__( 'Reset', 'bbp-core' ) .'</span>';
              echo '<span class="button csf-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'bbp-core' ), esc_html__( 'Cancel', 'bbp-core' ) ) .'</span>';
              echo '</label>';
              echo '</div>';
