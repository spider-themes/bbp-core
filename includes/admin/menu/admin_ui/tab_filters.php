<div class="easydocs-filter-container">
	<ul class="single-item-filter">
		<?php if ( in_array( 'all', $filter_set, true ) ) : ?>
			<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="all-<?php echo esc_attr( $item ); ?>" data-filter="all">
		...
		<?php if ( in_array( 'closed', $filter_set, true ) ) : ?>
			<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="closed-<?php echo esc_attr( $item ); ?>" data-filter=".closed-topics">
		...
		<?php if ( in_array( 'open', $filter_set, true ) ) : ?>
			<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="open-<?php echo esc_attr( $item ); ?>" data-filter=".open-topics">
		...
		<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="hidden-<?php echo esc_attr( $item ); ?>" data-filter=".hidden-topics">
		...
		<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="no_reply-<?php echo esc_attr( $item ); ?>" data-filter=".no-reply">
		...
		<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="solved-<?php echo esc_attr( $item ); ?>" data-filter=".solved">
		...
		<li class="easydocs-btn easydocs-btn-active easydocs-btn-sm" cookie-id="unsolved-<?php echo esc_attr( $item ); ?>" data-filter=".unsolved">
