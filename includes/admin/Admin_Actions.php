                            ...
                            <ul> 
                                ...
                                if( ! empty( $merged_post_ids ) ) :
                                    ...
                                    <li class="notify-item">
                                        <a href="<?php echo esc_attr($notify_permalink); ?>" target="_blank" class="d-flex">
                                            ...
                                            <div class="notify-content-wrap">
                                                <div class="notify-content-header d-flex justify-content-between">                                                    
                                                    ...
                                                    if( get_post_type( get_the_ID() ) == 'reply' ) : 
                                                        ?>
                                                            <span><?php esc_html_e( 'Reply', 'bbp-core-pro' ); ?></span>
                                                            <?php 
                                                        else :                                                            
                                                            if( $topic_status == 'closed' ) :                                                                
                                                            ...
                                                            echo ! empty( $is_topic_resolved == 1 ) ? sprintf( '<span>Resolved</span>', 'bbp-core-pro' ) : ''; 
                                                            endif;
                                                    endif; 
                                                    ?>
                                                    <span class="notify-creation"> 
                                                    <?php 
                                                        the_time( get_option('date_format') );
                                                        esc_html_e( ' at ', 'bbp-core-pro' );
