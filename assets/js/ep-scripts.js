        ...
        MegaMenu = ModuleHandler.extend({
            ...
            run: function () {
                ...
                if ($($elementor_section).find('.ep-virtual-area').length === 0) {
                    ...
                    $('#ep-megamenu-' + widgetID).clone().appendTo($elementor_section).wrapAll('<div class="ep-virtual-area" />');
                ...
                if ($($elementor_section).find('.bdt-accrodion-title-megamenu').length === 0) {
                    $elementor_section.find('.ep-virtual-area .ep-menu-nav-link').wrap("<span class='bdt-accordion-title bdt-accrodion-title-megamenu'></span>");
