...
<fieldset class="bbp-form bbpc-fieldset-signature">
	...
	<div class="<?php echo bbpc_signature_editor_class(); ?>">
		...
		<fieldset class="bbp-form bbpc-signature">
			...
			<span class="description">
				<?php echo sprintf( __( 'Signature length is limited to %s characters.', 'bbp-core' ), bbpc_signature()->settings['length'] ); ?><br/>
